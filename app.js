...
const translations = {
    sv: {
        ...
        footer:
            "Uråldrig tradition, buteljerad för modern gastronomi."
    },
    ...
    en: {
        ...
        footer:
            "Ancient tradition, bottled for modern gastronomy."
    },
    ...
    ar: {
        ...
        oilTitle: "زيت بكر ممتاز فاخر",
        oilText:
            "زيت متوازن بنضارة خضراء وفاكهية ناعمة ونهاية فلفلية أنيقة.",

        taste: "المذاق",
        tasteV: "أخضر وفاكهي مع لمسة فلفلية أنيقة.",
        ...
        footer:
            "تقاليد عريقة معبأة لفن الطهي الحديث."
    }
};
